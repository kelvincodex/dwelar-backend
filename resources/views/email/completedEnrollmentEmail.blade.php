                            ...
                            <tr>
                                <td style="padding-left:30px;padding-right:30px;">
                                    ...
                                    <div style="font-family: Tahoma, Verdana, sans-serif">
                                        <strong>Completed Enrollment</strong>
                                        <div class="txtTinyMce-wrapper"
                                            ...
                                            <p style="margin: 0; font-size: 16px; text-align: left; letter-spacing: normal;">
                                                <span style="font-size:15px;">Dear {{$user->username}}<br><br>
                                                Welcome to {{env("APP_NAME")}}  We're thrilled to have you join our community of travelers seeking the perfect stay for their adventures.
                                                    Your journey into seamless bookings and unforgettable stays starts now! <br><br>
                                                </span>
                                            </p>
